...
// NextAuth gère automatiquement le routage interne et les paramètres de route
// La signature simple fonctionne car NextAuth accepte les types any pour la compatibilité
